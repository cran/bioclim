...
bh2 <- bh
names(bh2) <- c('T', 'P', 'PET', 'P-PET', 'ppa', 'ST', paste0(expression(Delta),'ST'),
               'RET', 'Dh', 'S', 'R', '%R(P)')
...
bb <- biobal(bh, CC)
bb2 <- bb
names(bb2) <- c('p', 'T', 'PET', 'e', 'D', 'S', 's=e-D',
               expression(sum(s)), 'c=D-e', expression(sum(c)),
               'Q', 'x', 'E-e', 'D-e', 'Cd', 'T-7.5', 'B', 'b',
               'bl', 'bc')
